...
func newReadFileFn(root *os.Root) func(agent.Context, readFileInput) (readFileOutput, error) {
	return func(_ agent.Context, in readFileInput) (readFileOutput, error) {
...
func newWriteFileFn(root *os.Root) func(agent.Context, writeFileInput) (writeFileOutput, error) {
	return func(_ agent.Context, in writeFileInput) (writeFileOutput, error) {
...
func newListDirectoryFn(root *os.Root) func(agent.Context, listDirectoryInput) (listDirectoryOutput, error) {
	return func(_ agent.Context, in listDirectoryInput) (listDirectoryOutput, error) {
		path := in.Path
		if path == "" {
			path = "."
		}
...
func newMakeDirectoryFn(root *os.Root) func(agent.Context, makeDirectoryInput) (makeDirectoryOutput, error) {
	return func(_ agent.Context, in makeDirectoryInput) (makeDirectoryOutput, error) {
...
func newDeleteFileFn(root *os.Root) func(agent.Context, deleteFileInput) (deleteFileOutput, error) {
	return func(_ agent.Context, in deleteFileInput) (deleteFileOutput, error) {
...
func newListDatasetsFn(datasets *axiom.DatasetsService) func(agent.Context, listDatasetsInput) (listDatasetsOutput, error) {
	return func(ctx agent.Context, _ listDatasetsInput) (listDatasetsOutput, error) {
...
func newGetDatasetFn(datasets *axiom.DatasetsService) func(agent.Context, getDatasetInput) (datasetInfo, error) {
	return func(ctx agent.Context, in getDatasetInput) (datasetInfo, error) {
...
func newQueryDatasetFn(datasets *axiom.DatasetsService) func(agent.Context, queryDatasetInput) (queryDatasetOutput, error) {
	return func(ctx agent.Context, in queryDatasetInput) (queryDatasetOutput, error) {
...
func newFetchURLFn() func(agent.Context, fetchURLInput) (fetchURLOutput, error) {
	return func(ctx agent.Context, in fetchURLInput) (fetchURLOutput, error) {
